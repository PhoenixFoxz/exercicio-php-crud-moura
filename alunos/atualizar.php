...
<div class="container">
    ...
    <form action="#" method="post">
	    ...
	    <input value="<?=$aluno['primeira']?>" name="primeira" type="number" id="primeira" step="0.01" min="0.00" max="10.00" required></p>
        ...
        <p>
            ...
            <input name="media" value="<?=$aluno['media']?>" type="number" id="media" step="0.01" min="0.00" max="10.00" readonly disabled>
